...
def download(url, to=None):
    ...
    if to:
        ...
        #localfile = Path("./python_cko/docker_notebooks/notebooks/my_notebooks/downloads/" / filename)
        localfile = Path(Path.cwd() / 'docker_notebooks' / 'notebooks' / 'my_notebooks' / 'downloads' / filename)
